                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" class="form-control @error('sobrename') is-invalid @enderror"
                                id="lastName" placeholder="Sobrenome"  name="sobrename" value="{{ old('sobrename') }}" required>
                            @error('sobrename')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" class="form-control @error('CPF') is-invalid @enderror" id="CPF"
                                placeholder="999.999.999-99" value="{{ old('telefone') }}" name="CPF" required>
                            @error('CPF')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" class="form-control @error('telefone') is-invalid @enderror"
                                id="telefone" placeholder="+99(99)99999-9999" name="telefone" value="{{ old('telefone') }}" required>
                            @error('telefone')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
