<nav class="navbar flex-column flex-sm-row navbar-expand-lg" id="linhaca">
    ...
    <a class="navbar-brand" href="/">
        ...
        <p class="h4 text-start" style="color: #2B1998; font-size: 20px; margin-left: 12px; font-weight: bolder;">Cepetz
        </p>
    </a>
        ...
        <div class="collapse navbar-collapse justify-content-end" id="conteudoNavbarSuportado">
            ...
            <a href="{{ route('index') }}">
                <button class="btn my-2 my-sm-0"; id = "botaoo" type="submit"
                    style="margin-right: 15px; margin-left: 15px">Página inicial</button>
            </a>
            @guest
            <a href="{{ route('login') }}">
                <button class="btn my-2 my-sm-0"; id = "botaoo" type="submit"
                    style="margin-right: 15px; margin-left: 15px">Login</button>
            </a>
            ...
            @auth
                <a href="/favoritos/">
                    <button class="btn my-2 my-sm-0"; id= "botaoo" type="submit"
                        style="margin-right: 15px">Favoritos</button>
                </a>
                <a href="/cadastros/cadastrar/">
                    <button class="btn my-2 my-sm-0"; id= "botaoo" type="submit"
                        style="margin-right: 15px; margin-left: 15px">Cadastrar Animal</button>
                </a>
                @endif
                <a href="/sobre">
                    <button class="btn my-2 my-sm-0"; id= "botaoo" type="submit"
                        style="margin-right: 15px; margin-left: 15px">Sobre nós</button>
                </a>
                <a href="/cadastros/lista">
                    <button class="btn my-2 my-sm-0"; id= "botaoo" type="submit" style="margin-right: 15px">Lista
                        Adoções</button>
                </a>
                @auth
                    <a id="botaoo" href="{{ route('logout') }}"
